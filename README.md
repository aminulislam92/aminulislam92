...
## 🚀 About Me
Mid-level MERN Stack Developer with 1+ years of experience building, maintaining, and improving modern web applications and RESTful APIs. Strong background in React (including Hooks and Context/Redux), Node.js, Express.js, MongoDB, and JavaScript, with hands-on experience in authentication, authorization, API development, database design, state management, and performance optimization. I'm passionate about writing clean, maintainable, and scalable code, building production-ready features, debugging complex issues, and continuously improving my development skills. I also enjoy working with Git, GitHub, Postman, Docker, CI/CD, and cloud deployment, and I'm comfortable working in collaborative development environments and contributing to code reviews and technical decisions.
